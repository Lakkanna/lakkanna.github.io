...
const experiences: ExperienceItem[] = [
  {
    ...
    description:
      'Providing technical leadership to a six-member engineering team, establishing architectural standards, scalable design frameworks, and development best practices. Designing and directing the development of an AI-powered Just-in-Time Training Platform.',
    achievements: [
  ...
  },
  {
    ...
    description:
      'Redesigned platform architecture to achieve a 35% performance uplift through intelligent implementation of lazy loading, dynamic imports, and optimized code-splitting strategies.',
    achievements: [
  ...
  },
  {
    ...
    description:
      'Modernized legacy applications by refactoring from class-based React components to hooks-based architecture, improving maintainability and rendering performance.',
    achievements: [
    ...
    <div className="flex flex-1 justify-center px-4 py-10 sm:px-10 md:px-20 lg:px-40">
      <div className="flex max-w-[960px] flex-1 flex-col gap-12">
        <div className="flex flex-wrap justify-between gap-3 text-center">
          <h1 className="w-full text-4xl font-black leading-tight tracking-[-0.033em] text-text-light dark:text-text-dark md:text-4xl text-background mx-auto">
            Career Journey
          </h1>
        </div>
