...
const Chat = () => {
    ...
    const sendMessage = async () => {
        if (!input.trim() || !worker.current || isLoading) return;
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50 flex flex-col items-end space-y-4">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50 dark:bg-gray-900">
                        {messages.map((msg, idx) => (
                            <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                <div className={`max-w-[80%] rounded-lg p-2 text-sm shadow-sm ${msg.role === 'user'
                            ...
                            !modelDownloaded ? (
                                ...
                                <>
                                    <input
                                        ...
                                        placeholder={isModelLoading ? "Initializing..." : "Type a message..."}
            ...
            <button
                ...
                className={`p-4 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${showDialog
